...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(minibuffer-prompt ((,class (:weight normal :foreground "blue" :background "white"))))
   `(minibuffer-noticeable-prompt ((,class (:weight normal :foreground "blue" :background "white"))))
   ...
   `(font-lock-preprocessor-face ((,class (:foreground "#D4A190"))))
